...
import '../../widgets/gesture/gesture_password.dart';
import '../../widgets/gesture/mini_gesture_password.dart';
import 'package:flutter/rendering.dart';
// import '../package:flutter_custom_bottom_tab_bar/tabbar.dart';
// import '../package:flutter_custom_bottom_tab_bar/eachtab.dart';
import 'package:flutter_custom_bottom_tab_bar/tabbar.dart';
import 'package:flutter_custom_bottom_tab_bar/eachtab.dart';
import 'package:jinritoutiao/routers/home/channels.dart';
...
class _HomeState extends State<Home> with SingleTickerProviderStateMixin {
  ...
  // Widget eachTab = (BuildContext context) => Container(
  //     padding: EdgeInsets.fromLTRB(18, 10, 0, 10),
  //     child: Stack(
  //       alignment: AlignmentDirectional.centerStart,
  //       children: <Widget>[Text('12312312312312')],
  //     ));
  @override
                ...
                children: <Widget>[
                  ...
                  Positioned(
                    child: GestureDetector(
                      onTap: () => Channels().mainBottom(context),
                      child: Row(
                        children: <Widget>[
