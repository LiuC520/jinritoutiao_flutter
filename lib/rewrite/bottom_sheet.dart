...
/**
 * 刘成新加了 maxHeight
 * 可以设置bottomsheet的高度，高度是屏幕高度 * 9.0 / 16.0
 * 也可以在最外层设置高度，不设置就是默认的高度
 */
import 'dart:async';
...
class _ModalBottomSheetLayout extends SingleChildLayoutDelegate {
  _ModalBottomSheetLayout(this.progress, this.maxHeight);
  ...
  BoxConstraints getConstraintsForChild(BoxConstraints constraints) {
    return BoxConstraints(
        ...
        minHeight: 0.0,
        maxHeight: maxHeight ?? constraints.maxHeight * 9.0 / 16.0);
  }
                ...
                child: ClipRect(
                  child: CustomSingleChildLayout(
                    delegate: _ModalBottomSheetLayout(
                        animationValue, widget.route.maxHeight),
                    child: BottomSheet(
...
class _ModalBottomSheetRoute<T> extends PopupRoute<T> {
   ...
   * 动画
   */
  final RouteTransitionsBuilder transitionsWidgetBuilder;
  @override
...
Future<T> showModalBottomSheet<T>(
  ...
  return Navigator.push(
      ...
      _ModalBottomSheetRoute<T>(
        ...
        transitionsWidgetBuilder: routeTransitionsBuilder, //动画
        barrierLabel:
