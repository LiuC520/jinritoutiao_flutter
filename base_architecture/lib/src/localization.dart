...
import 'package:base_architecture/src/localizations/messages_all.dart';
...
class ArchSampleLocalizations {
  ...
  String get homeTab => Intl.message(
        '首页',
        name: 'homeTab',
        args: [],
        locale: locale.toString(),
...
/**
 * 取值，根据名字取值，如果 messages_en里面有这个名字 xiguaVideo,就会取里面的值
 * 否则在 messages_en找不到对应的 xiguaVideo，就会取值西瓜
 */
  String get xiguaVideoTab => Intl.message(
        '西瓜123123123123',
        name: 'xiguaVideo',
        args: [],
        locale: locale.toString(),
      );
  String get findTab => Intl.message(
        '找人',
        name: 'findTab',
        args: [],
        locale: locale.toString(),
  ...
  String get littleVideoTab => Intl.message(
        '小视频',
        name: 'littleVideoTab',
        args: [],
        locale: locale.toString(),
      );
  String get myTab => Intl.message(
        '我的',
        name: 'myTab',
        args: [],
        locale: locale.toString(),
